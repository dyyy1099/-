...
def main(set, args):
    ...
    if args.dataset == "DFEW":
        ...
        train_annotation_file_path = "./annotation/DFEW_set_"+str(data_set)+"_train(single-labeled).txt"
        test_annotation_file_path = "./annotation/DFEW_set_"+str(data_set)+"_test(single-labeled).txt"
